            ...
            <div className='relative isolate'>
                <div
                    ...
                    <div
                        ...
                        className='relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#80ff8b] to-[#006eff] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]'
                    />
                </div>
                ...
                <div
                    ...
                    <div
                        ...
                        className='relative left-[calc(50%-13rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#80ffa6] to-[#0099ff] opacity-30 sm:left-[calc(50%-36rem)] sm:w-[72.1875rem]'
                    />
                </div>
            </div>
        </div>
